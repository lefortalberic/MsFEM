function [lambda,Psi_1,Psi_2] = Solution_pb_spectral_adjoint(Nbpt)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%        
...
MM_sigma = [MM_sigma11 , MM_sigma21 ; MM_sigma12 , MM_sigma22]; %J'inverse ici les deux matrices non 
% dans la diagonale pour le probleme adjoint 
...
Psi_1 = Psi_1./mean_Psi_1_carre;
mean_Psi_2_carre = sqrt(mean(Psi_2.*Psi_2));
Psi_2 = Psi_2./mean_Psi_2_carre;
